...
if __name__ == '__main__':
    ...
    spectra = [(row['Charge']*row["m/z"]-1.00726*row['Charge'],1) for index, row in df.iterrows() ]
    ...
    plt.vlines([ordered_spectra[x][0] for x in range(len(ordered_spectra))],0,[ordered_spectra[x][1] for x in range(len(ordered_spectra))])
    plt.show()